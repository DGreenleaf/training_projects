...
public class Player {//Объясню название класса-я планировал сделать режим игры Игрок vs PC. Думал создавать объект игрока или компьютера, в зависимости от того, как хочет играть пользователь.
    String coordinates;
